...
public class PingRepReqMessageTest {
	...
	private PingRepReqMessageConverter converter = new PingRepReqMessageConverter();
	...
	public void testDeserialization() {
		PingRepReqMessage actualMessage = converter.deserialize(createSerializedMessage(type, command, senderId,
	...
	public void testSerDeserMessage() {
		...
		PingRepReqMessage deserializedMessage = converter.deserialize(serializedMessage);
