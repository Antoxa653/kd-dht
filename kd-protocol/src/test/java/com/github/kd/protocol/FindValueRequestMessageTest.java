...
public class FindValueRequestMessageTest {
	...
	public void testDeserialization() {
		FindValueRequestMessage actualMessage = (FindValueRequestMessage) ConverterUtils
				.deserialize(createSerializedMessage(type,
						command, senderId,
						lookUpId, randomId));
		FindValueRequestMessage expectedMessage = new FindValueRequestMessage(type, command, senderId, lookUpId,
				randomId);
	...
	public void testSerDeserMessage() {
		FindValueRequestMessage initialMessage = new FindValueRequestMessage(type, command, senderId, lookUpId,
				randomId);
		ByteBuffer serializedMessage = ConverterUtils.serialize(initialMessage);
		FindValueRequestMessage deserializedMessage = (FindValueRequestMessage) ConverterUtils
