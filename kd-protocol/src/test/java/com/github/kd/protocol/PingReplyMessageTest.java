...
public class PingReplyMessageTest {	
	...
	public void testDeserialization() {
		PingReplyMessage actualMessage = (PingReplyMessage) ConverterUtils.deserialize(createSerializedMessage(type,
				command, senderId,
				echoedRandomId));
	...
	public void testSerDeserMessage() {
		...
		PingReplyMessage deserializedMessage = (PingReplyMessage) ConverterUtils.deserialize(serializedMessage);
