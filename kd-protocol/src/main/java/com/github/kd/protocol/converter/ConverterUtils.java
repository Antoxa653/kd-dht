...
public final class ConverterUtils {
	...
	static {
		...
		REQUEST_MESSAGE_CONVERTERS.put(MessageCommand.STORE, new StoreRequestMessageConverter());
		...
		REPLY_MESSAGE_CONVERTERS.put(MessageCommand.STORE, new StoreReplyMessageConverter());
	}
